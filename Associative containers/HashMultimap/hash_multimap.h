...
namespace MiniSTL {
    ...
    template <class Key, class Value, class HashFcn, class EqualKey, class Alloc> class hash_multimap;

    template <class Key, class Value, class HashFcn, class EqualKey, class Alloc>
    inline bool operator==(const hash_multimap<Key, Value, HashFcn, EqualKey, Alloc> &,
    ...
    class hash_multimap {
        ...
        friend bool operator==(const hash_multimap<_Key, _Value, _HashFcn, _EqualKey, _Alloc> &,
    ...
    public: // swap
        void swap(hash_multimap &rhs) noexcept {
            rep.swap(rhs.rep);
        }
    ...
    template <class Key, class Value, class HashFcn, class EqualKey, class Alloc>
    inline bool operator==(const hash_multimap<Key, Value, HashFcn, EqualKey, Alloc> &lhs,
    ...
    template <class Key, class Value, class HashFcn, class EqualKey, class Alloc>
    inline void swap(const hash_multimap<Key, Value, HashFcn, EqualKey, Alloc> &lhs,
                     const hash_multimap<Key, Value, HashFcn, EqualKey, Alloc> &rhs) {
        lhs.swap(rhs);
    }
