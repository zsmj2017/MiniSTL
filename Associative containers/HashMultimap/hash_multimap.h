...
template <class Key,class Value, class HashFcn, class EqualKey, class Alloc>
inline bool operator==(const hash_multimap<Key, Value, HashFcn, EqualKey, Alloc>&, const hash_multimap<Key, Value, HashFcn, EqualKey, Alloc>&);

template <class Key, class Value, class HashFcn = hash<Value>, class EqualKey = equal_to<Value>, class Alloc = simpleAlloc<Value> >
class hash_multimap{
	// friend declaration
	template <class _Key,class _Value, class _HashFcn, class _EqualKey, class _Alloc>
	friend bool operator==(const hash_multimap<_Key, _Value, _HashFcn, _EqualKey, _Alloc>&, const hash_multimap<_Key, _Value, _HashFcn, _EqualKey, _Alloc>&);
...
public:// getter
	...
	size_type elems_in_bucket(size_type n) const noexcept { return rep.elems_in_bucket(n); }
...
public:// swap
	void swap(hash_multimap& rhs) noexcept { rep.swap(rhs.rep); }
...
template <class Key,class Value, class HashFcn, class EqualKey, class Alloc>
inline bool operator==(const hash_multimap<Key, Value, HashFcn, EqualKey, Alloc>& lhs, const hash_multimap<Key, Value, HashFcn, EqualKey, Alloc>& rhs) {
...
template <class Key,class Value, class HashFcn, class EqualKey, class Alloc>
inline void swap(const hash_multimap<Key, Value, HashFcn, EqualKey, Alloc>& lhs, const hash_multimap<Key, Value, HashFcn, EqualKey, Alloc>& rhs) {
	lhs.swap(rhs);
}
