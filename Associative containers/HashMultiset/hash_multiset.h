...
template <class Value, class HashFcn, class EqualKey, class Alloc>
inline bool operator==(const hash_multiset<Value, HashFcn, EqualKey, Alloc>&, const hash_multiset<Value, HashFcn, EqualKey, Alloc>&);

template <class Value, class HashFcn = hash<Value>, class EqualKey = equal_to<Value>, class Alloc = simpleAlloc<Value> >
class hash_multiset {
	// friend declarations
	template <class _Value, class _HashFcn, class _EqualKey, class _Alloc>
	friend bool operator==(const hash_multiset<_Value, _HashFcn, _EqualKey, _Alloc>&, const hash_multiset<_Value, _HashFcn, _EqualKey, _Alloc>&);
...
template <class Value, class HashFcn, class EqualKey, class Alloc>
inline void swap(const hash_multiset<Value, HashFcn, EqualKey, Alloc>& lhs, const hash_multiset<Value, HashFcn, EqualKey, Alloc>& rhs) {
	lhs.swap(rhs);
}
