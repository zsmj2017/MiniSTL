...
namespace MiniSTL {
    ...
    template <class Value, class HashFcn, class EqualKey, class Alloc> class hash_multiset;
    ...
    class hash_multiset {
        ...
        friend bool operator==(const hash_multiset<_Value, _HashFcn, _EqualKey, _Alloc> &,
    ...
    public: // swap
        void swap(hash_multiset &rhs) noexcept {
            rep.swap(rhs.rep);
        }
