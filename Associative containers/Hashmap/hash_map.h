...
template <class Key,class Value, class HashFcn, class EqualKey, class Alloc>
inline bool operator==(const hash_map<Key, Value, HashFcn, EqualKey, Alloc>&, const hash_map<Key, Value, HashFcn, EqualKey, Alloc>&);
...
class hash_map{
	...
	friend bool operator==(const hash_map<_Key, _Value, _HashFcn, _EqualKey, _Alloc>&, const hash_map<_Key, _Value, _HashFcn, _EqualKey, _Alloc>&);
...
template <class Key,class Value, class HashFcn, class EqualKey, class Alloc>
inline bool operator==(const hash_map<Key, Value, HashFcn, EqualKey, Alloc>& lhs, const hash_map<Key, Value, HashFcn, EqualKey, Alloc>& rhs) {
...
template <class Key,class Value, class HashFcn, class EqualKey, class Alloc>
inline void swap(const hash_map<Key, Value, HashFcn, EqualKey, Alloc>& lhs, const hash_map<Key, Value, HashFcn, EqualKey, Alloc>& rhs) {
	lhs.swap(rhs);
}
