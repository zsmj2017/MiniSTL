...
namespace MiniSTL {
    ...
    template <class Value, class HashFcn, class EqualKey, class Alloc> class hash_set;
    ...
    class hash_set {
        ...
        friend bool operator==(const hash_set<_Value, _HashFcn, _EqualKey, _Alloc> &,
    ...
    public: // swap
        void swap(hash_set &rhs) noexcept {
            rep.swap(rhs.rep);
        }
