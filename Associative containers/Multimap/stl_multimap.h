...
namespace MiniSTL {
    ...
    template <class Key, class T, class Compare = less<Key>, class Alloc = simpleAlloc<T>> class multimap {
        // friend declarations
    ...
    public: // ctor
        ...
        template <class InputIterator> multimap(InputIterator first, InputIterator last) : t(key_compare()) {
            t.insert_equal(first, last);
        }
        template <class InputIterator>
        multimap(InputIterator first, InputIterator last, const key_compare &comp) : t(comp) {
            t.insert_equal(first, last);
        }
    ...
    public: // swap
        void swap(multimap<Key, T, Compare, Alloc> &x) noexcept {
            t.swap(x.t);
        }
