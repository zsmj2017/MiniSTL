...
namespace MiniSTL {
    ...
    template <class Key, class Compare = less<Key>, class Alloc = simpleAlloc<Key>> class multiset {
        // friend declarations
    ...
    public: // ctor
        ...
        template <class InputIterator> multiset(InputIterator first, InputIterator last) : t(key_compare()) {
            t.insert_equal(first, last);
        }
        template <class InputIterator>
        multiset(InputIterator first, InputIterator last, const key_compare &comp) : t(comp) {
            t.insert_equal(first, last);
        }
    ...
    public: // swap
        void swap(multiset<Key, Compare, Alloc> &x) noexcept {
            t.swap(x.t);
        }
