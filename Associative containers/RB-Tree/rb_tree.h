...
namespace MiniSTL {
    ...
    template <class Key, class Value, class KeyOfValue, class Compare, class Alloc = simpleAlloc<Value>> class rb_tree {
    ...
    public: // insert
        ...
        template <class InputIterator> void insert_unique(InputIterator, InputIterator);
        iterator insert_equal(iterator, const value_type &);
        iterator insert_equal(const value_type &);
        template <class InputIterator> void insert_equal(InputIterator, InputIterator);
    ...
    template <class Key, class Value, class KeyOfValue, class Compare, class Alloc>
    inline rb_tree<Key, Value, KeyOfValue, Compare, Alloc> &rb_tree<Key, Value, KeyOfValue, Compare, Alloc>::
    ...
    rb_tree<Key, Value, KeyOfValue, Compare, Alloc>::insert_equal(const value_type &val) {
        ...
        while (x) {
            y = x;
            x = key_compare(KeyOfValue()(val), key(x)) ? left(x) : right(x); // 大则向左
        }
