...
namespace MiniSTL {
    ...
    template <class Key, class Compare = less<Key>, class Alloc = simpleAlloc<Key>> class set {
        // friend declarations
    ...
    public: // ctor
        ...
        set(InputIterator first, InputIterator last, const key_compare &comp = Compare()) : t(comp) {
            t.insert_unique(first, last);
        }
        set(std::initializer_list<value_type> ils, const key_compare &comp = Compare()) : t(comp) {
