...
namespace MiniSTL {
    ...
    template <class Pair> struct select1st : public unary_function<Pair, typename Pair::first_type> {
        const typename Pair::first_type &operator()(const Pair &x) const {
            return x.first;
        }
    };

    template <class Pair> struct select2nd : public unary_function<Pair, typename Pair::second_type> {
        const typename Pair::second_type &operator()(const Pair &x) const {
            return x.second;
        }
    };

    template <class Arg1, class Arg2> struct project1st : public binary_function<Arg1, Arg2, Arg1> {
        Arg1 operator()(const Arg1 &x, const Arg2 &) const {
            return x;
        }
    };

    template <class Arg1, class Arg2> struct Project2nd : public binary_function<Arg1, Arg2, Arg2> {
    ...
    template <class Predicate> inline unary_negate<Predicate> not1(const Predicate &pred) {
    ...
    template <class _Predicate> inline binary_negate<_Predicate> not2(const _Predicate &pred) {
    ...
    template <class Operation, class T> inline binder1st<Operation> bind1st(const Operation &op, const T &x) {
    ...
    template <class Arg, class Result> inline pointer_to_unary_function<Arg, Result> ptr_fun(Result (*x)(Arg)) {
    ...
    template <class S, class T, class Arg> class mem_fun1_t : public binary_function<T *, Arg, S> {
    public:
        explicit mem_fun1_t(S (T::*pf)(Arg)) : f(pf) {}
        S operator()(T *p, Arg x) const {
            return (p->*f)(x);
        }
    ...
    template <class S, class T, class Arg> class const_mem_fun1_t : public binary_function<const T *, Arg, S> {
    public:
    ...
    template <class S, class T, class Arg> class mem_fun1_ref_t : public binary_function<T, Arg, S> {
    public:
    ...
    template <class S, class T, class Arg> class const_mem_fun1_ref_t : public binary_function<T, Arg, S> {
    public:
    ...
    template <class T> class mem_fun_t<void, T> : public unary_function<T *, void> {
    public:
    ...
    template <class T> class const_mem_fun_t<void, T> : public unary_function<const T *, void> {
    public:
    ...
    template <class T> class mem_fun_ref_t<void, T> : public unary_function<T, void> {
    public:
    ...
    template <class T> class const_mem_fun_ref_t<void, T> : public unary_function<T, void> {
    public:
    ...
    template <class T, class Arg> class mem_fun1_t<void, T, Arg> : public binary_function<T *, Arg, void> {
    public:
    ...
    template <class T, class Arg> class const_mem_fun1_t<void, T, Arg> : public binary_function<const T *, Arg, void> {
    public:
    ...
    template <class T, class Arg> class mem_fun1_ref_t<void, T, Arg> : public binary_function<T, Arg, void> {
    public:
    ...
    template <class T, class Arg> class const_mem_fun1_ref_t<void, T, Arg> : public binary_function<T, Arg, void> {
    public:
    ...
    template <class S, class T> inline mem_fun_t<S, T> mem_fun(S (T::*f)()) {
        return mem_fun_t<S, T>(f);
    }

    template <class S, class T> inline const_mem_fun_t<S, T> mem_fun(S (T::*f)() const) {
        return const_mem_fun_t<S, T>(f);
    }

    template <class S, class T> inline mem_fun_ref_t<S, T> mem_fun_ref(S (T::*f)()) {
        return mem_fun_ref_t<S, T>(f);
    }

    template <class S, class T> inline const_mem_fun_ref_t<S, T> mem_fun_ref(S (T::*f)() const) {
        return const_mem_fun_ref_t<S, T>(f);
    }

    template <class S, class T, class Arg> inline mem_fun1_t<S, T, Arg> mem_fun(S (T::*f)(Arg)) {
        return mem_fun1_t<S, T, Arg>(f);
    }

    template <class S, class T, class Arg> inline const_mem_fun1_t<S, T, Arg> mem_fun(S (T::*f)(Arg) const) {
        return const_mem_fun1_t<S, T, Arg>(f);
    }

    template <class S, class T, class Arg> inline mem_fun1_ref_t<S, T, Arg> mem_fun_ref(S (T::*f)(Arg)) {
        return mem_fun1_ref_t<S, T, Arg>(f);
    }

    template <class S, class T, class Arg> inline const_mem_fun1_ref_t<S, T, Arg> mem_fun_ref(S (T::*f)(Arg) const) {
        return const_mem_fun1_ref_t<S, T, Arg>(f);
    }

    template <class S, class T, class Arg> inline mem_fun1_t<S, T, Arg> mem_fun1(S (T::*f)(Arg)) {
        return mem_fun1_t<S, T, Arg>(f);
    }

    template <class S, class T, class Arg> inline const_mem_fun1_t<S, T, Arg> mem_fun1(S (T::*f)(Arg) const) {
        return const_mem_fun1_t<S, T, Arg>(f);
    }

    template <class S, class T, class Arg> inline mem_fun1_ref_t<S, T, Arg> mem_fun1_ref(S (T::*f)(Arg)) {
        return mem_fun1_ref_t<S, T, Arg>(f);
    }

    template <class S, class T, class Arg> inline const_mem_fun1_ref_t<S, T, Arg> mem_fun1_ref(S (T::*f)(Arg) const) {
        return const_mem_fun1_ref_t<S, T, Arg>(f);
    }
    ...
    template <class T1, class T2> struct pair {
        ...
        template <class U1, class U2> pair(const pair<U1, U2> &rhs) : first(rhs.first), second(rhs.second) {}
    };

    // Compartor for pair
    template <class T1, class T2> inline bool operator==(const pair<T1, T2> &lhs, const pair<T1, T2> &rhs) {
    ...
    // make pair
    template <class T1, class T2> inline pair<T1, T2> make_pair(const T1 &first, const T2 &second) {
