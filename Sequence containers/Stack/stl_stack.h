...
namespace MiniSTL {
    ...
    template <class T, class Sequence> bool operator==(const stack<T, Sequence> &, const stack<T, Sequence> &);
    ...
    template <class T, class Sequence> inline void swap(stack<T, Sequence> &lhs, stack<T, Sequence> &rhs) noexcept {
        lhs.swap(rhs);
    }
