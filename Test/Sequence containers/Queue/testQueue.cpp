...
TEST_F(Priority_Queue_Test, CTOR_WITH_INITIALIZER_LIST) {
    EXPECT_NO_THROW((priority_queue<int, vector<int>, less<int>>{1, 2, 3, 4, 5}));
    EXPECT_NO_THROW((priority_queue<int, deque<int>, less<int>>{1, 2, 3, 4, 5}));
    EXPECT_NO_THROW((priority_queue<float, vector<float>, greater<float>>{1, 2, 3, 4, 5}));
    EXPECT_NO_THROW((priority_queue<double, deque<double>, greater<double>>{1, 2, 3, 4, 5}));
}

TEST_F(Priority_Queue_Test, CTOR_WITH_INPUTITERATOR) {
    vector<int> temp_vi{1, 2, 3, 4, 5};
    list<int> temp_li{1, 2, 3, 4, 5};
    EXPECT_NO_THROW((priority_queue<int, vector<int>, less<int>>{temp_vi.begin(), temp_vi.end()}));
    EXPECT_NO_THROW((priority_queue<int, vector<int>, less<int>>{temp_li.begin(), temp_li.end()}));
    EXPECT_NO_THROW((priority_queue<int, deque<int>, less<int>>{temp_vi.begin(), temp_vi.end()}));
    EXPECT_NO_THROW((priority_queue<int, deque<int>, less<int>>{temp_li.begin(), temp_li.end()}));
    // C API
    int ai[5] = {1, 2, 3, 4, 5};
    ...
    EXPECT_NO_THROW((priority_queue<double, vector<double>, less<double>>{ad, ad + 5}));
    EXPECT_NO_THROW((priority_queue<double, deque<double>, less<double>>{ad, ad + 5}));
    EXPECT_NO_THROW((priority_queue<double, deque<double>, greater<double>>{ai, ai + 5}));
    EXPECT_NO_THROW((priority_queue<double, deque<double>, greater<double>>{ai, ai + 5}));
}
...
TEST_F(Priority_Queue_Test, MOVE_CTOR) {
    EXPECT_NO_THROW((priority_queue<int, vector<int>, less<int>>{std::move(pqvl)}));
    EXPECT_NO_THROW((priority_queue<int, vector<int>, greater<int>>{std::move(pqvg)}));
    EXPECT_NO_THROW((priority_queue<int, deque<int>, less<int>>{std::move(pqdl)}));
    EXPECT_NO_THROW((priority_queue<int, deque<int>, greater<int>>{std::move(pqdg)}));
}
